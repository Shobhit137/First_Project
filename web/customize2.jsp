        ...
        <div class="container">
            <div class="row">
                <form method="post" id="f1"> 
                    <input type="radio" value="style1" name="style" ${(theam_class == "style1")?"checked":""} />Light Theme 
                <input type="radio" value="style2" name="style" ${theam_class == "style2" ? "checked" : ""}/>Dark Theme
                </form>
            </div>
